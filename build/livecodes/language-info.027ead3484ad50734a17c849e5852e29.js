var e=`<section data-lang="art-template">
  <h3>art-template</h3>
  <div>High performance JavaScript templating engine.</div>
  <ul>
    <li>
...
<section data-lang="assemblyscript">
  ...
  <ul>
    ...
    <li>
      <a href="?template=assemblyscript" target="_parent" data-template="assemblyscript"
...
<section data-lang="astro">
  <h3>Astro</h3>
  <div>Build faster websites with less client-side Javascript. (Still in Beta)</div>
  <ul>
    <li>
    ...
    <li>
      <a href="?template=astro" target="_parent" data-template="astro">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="babel">
  ...
  <ul>
    ...
    <li>
      <a href="https://babeljs.io/docs/en/" target="_blank" rel="noopener">Babel documentation</a>
    </li>
  </ul>
</section>
<section data-lang="clio">
  ...
  <ul>
    ...
    <li>
      <a href="?template=clio" target="_parent" data-template="clio">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="cpp">
  <h3>C++</h3>
  <div>C++ support using JSCPP (a simple C++ interpreter written in JavaScript).</div>
  <div>
  ...
  <ul>
    ...
    <li>
      <a href="?template=cpp" target="_parent" data-template="cpp">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="clang">
  <h3>Clang compiler</h3>
  <div>
    Clang C/C++ compiler running on WASM, using
  ...
  <ul>
    ...
    <li>
      <a href="?template=clang" target="_parent" data-template="clang">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="coffeescript">
  ...
  <ul>
    ...
    <li>
      <a href="?template=coffeescript" target="_parent" data-template="coffeescript"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="commonlisp">
  ...
  <ul>
    ...
    <li>
      <a href="?template=commonlisp" target="_parent" data-template="commonlisp"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="diagrams">
  <h3>Diagrams</h3>
  <div>Diagrams-as-code. Supports:</div>
  ...
  <ul>
    ...
    <li>
      <a href="/docs/languages/diagrams" target="_blank" rel="noopener">LiveCodes Documentation</a>
    </li>
  </ul>
</section>
...
<section data-lang="imba">
  <h3>Imba</h3>
  <div>The friendly full-stack language.</div>
  <ul>
...
<section data-lang="jsx">
  ...
  <ul>
    ...
    <li>
      <a href="?template=react" target="_parent" data-template="react">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="julia">
  ...
  <ul>
    ...
    <li>
      <a href="?template=julia" target="_parent" data-template="julia">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="livescript">
  ...
  <ul>
    ...
    <li>
      <a href="?template=livescript" target="_parent" data-template="livescript"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="malina">
  <h3>Malina.js</h3>
  <div>Frontend compiler, inspired by Svelte.</div>
  <ul>
    <li>
    ...
    <li>
      <a href="?template=malina" target="_parent" data-template="malina">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="markdown">
  ...
  <ul>
    ...
    <li>
      <a href="?template=markdown" target="_parent" data-template="markdown"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="ocaml">
  ...
  <ul>
    ...
    <li>
      <a href="?template=ocaml" target="_parent" data-template="ocaml">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="perl">
  ...
  <ul>
    ...
    <li>
      <a href="?template=perl" target="_parent" data-template="perl">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="prolog">
  ...
  <ul>
    ...
    <li>
      <a href="?template=prolog" target="_parent" data-template="prolog">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="pyodide">
  ...
  <ul>
    ...
    <li>
      <a href="?template=pyodide" target="_parent" data-template="pyodide">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="reason">
  ...
  <ul>
    ...
    <li>
      <a href="?template=reason" target="_parent" data-template="reason">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="rescript">
  ...
  <ul>
    ...
    <li>
      <a href="?template=rescript" target="_parent" data-template="rescript"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="richtext">
  ...
  <div>Using Quill:</div>
  <div>Your powerful rich text editor.</div>
  <ul>
    <li>
...
<section data-lang="riot">
  ...
  <ul>
    ...
    <li>
      <a href="?template=riot" target="_parent" data-template="riot">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="scheme">
  ...
  <ul>
    ...
    <li>
      <a href="?template=scheme" target="_parent" data-template="scheme">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="stencil">
  ...
  <ul>
    ...
    <li>
      <a href="?template=stencil" target="_parent" data-template="stencil">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="svelte">
  ...
  <ul>
    ...
    <li>
      <a href="?template=svelte" target="_parent" data-template="svelte">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="tcl">
  <h3>Tcl (Tool Command Language)</h3>
  <div>
  ...
  <ul>
    ...
    <li>
      <a href="?template=tcl" target="_parent" data-template="tcl">Load starter template</a>
    </li>
  </ul>
</section>
...
<section data-lang="typescript">
  ...
  <ul>
    ...
    <li>
      <a href="?template=typescript" target="_parent" data-template="typescript"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="blockly">
  <h3>Blockly</h3>
  <div>A JavaScript library for building visual programming editors.</div>
  <ul>
    <li>
    ...
    <li>
      <a href="?template=blockly" target="_parent" data-template="blockly">Load starter template</a>
    </li>
  </ul>
</section>
<section data-lang="style-processors">
  <h3>CSS Utilities and Processors</h3>
  <ul>
    <li>
